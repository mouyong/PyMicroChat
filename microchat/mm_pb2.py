...
_OPLOG_REQ_TAG1_CMD_OPTION_OP = _descriptor.Descriptor(
  name='OP',
  full_name='oplog_req.TAG1.CMD.OPTION.OP',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='tag1', full_name='oplog_req.TAG1.CMD.OPTION.OP.tag1', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tag2', full_name='oplog_req.TAG1.CMD.OPTION.OP.tag2', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tag3', full_name='oplog_req.TAG1.CMD.OPTION.OP.tag3', index=2,
      number=3, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPLOG_REQ_TAG1_CMD_OPTION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='op', full_name='oplog_req.TAG1.CMD.OPTION.op', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_OPLOG_REQ_TAG1_CMD_OPTION_OP, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_OPLOG_REQ_TAG1_CMD_OPTION_OP.containing_type = _OPLOG_REQ_TAG1_CMD_OPTION
_OPLOG_REQ_TAG1_CMD_OPTION.fields_by_name['op'].message_type = _OPLOG_REQ_TAG1_CMD_OPTION_OP
    ...
    CMD = _reflection.GeneratedProtocolMessageType('CMD', (_message.Message,), dict(
      ...
      OPTION = _reflection.GeneratedProtocolMessageType('OPTION', (_message.Message,), dict(
        ...
        OP = _reflection.GeneratedProtocolMessageType('OP', (_message.Message,), dict(
          DESCRIPTOR = _OPLOG_REQ_TAG1_CMD_OPTION_OP,
          __module__ = 'mm_pb2'
          # @@protoc_insertion_point(class_scope:oplog_req.TAG1.CMD.OPTION.OP)
          ))
        ,
...
_sym_db.RegisterMessage(oplog_req.TAG1.CMD.OPTION.OP)
